...
```
  Ans:-  Estimated standard errors of coefficient associat with income and balance is 4.985e-06 and 2.274e-04.
...
```
  ...
  Ans:- using the  boot.fn function to use  return the coefficient value of  income and balance  2.080898e-05 and 5.647103e-03.
...
```
  ...
  Ans:use to find out  the Glm function variable Lag1 and Lag2
...
```
  ...
  Ans:- use to Finding out the Glm function for the variable Lag1 and Lag2 here we not considered  the first column by LOOCV method
